"""Generate 9 additional moderate-letter replications (reps 2-10) for each of the
480 replicated resumes. Rep 1 already exists from generate_all_moderate_letters.py;
...
OUTPUT_DIR = Path.home() / "Desktop" / "generated_letters_moderate_480_replications"
EFFORT = "medium"
MAX_WORKERS = 6
MAX_RETRIES = 5
